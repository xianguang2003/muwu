...
public class GlobalConstant {
	...
	public static final String ROOT_PREFIX = "muwu";

	public static final int EXCEPTION_CAUSE_MAX_LENGTH = 2048;
	public static final int EXCEPTION_MESSAGE_MAX_LENGTH = 2048;

	public static final String ZK_REGISTRY_SERVICE_ROOT_PATH = "/muwu/registry/service";
	public static final String ZK_REGISTRY_ID_ROOT_PATH = "/muwu/registry/id";
	public static final String ZK_REGISTRY_PRODUCER_ROOT_PATH = "/muwu/registry/producer";
	public static final String ZK_REGISTRY_CONSUMER_ROOT_PATH = "/muwu/registry/consumer";
	public static final String ZK_REGISTRY_SEQ = "/muwu/seq";
	...
	public static final class Sys {
		 ...
		 * 全局用户名
		 */
		public static final String CURRENT_BASIC_USER = "CURRENT_BASIC_USER";
		 ...
		 */
		public static final String DEFAULT_FILE_PATH = "muwu/file/";
