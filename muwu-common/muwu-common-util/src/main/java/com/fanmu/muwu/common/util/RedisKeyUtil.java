...
public class RedisKeyUtil {
	 ...
	 */
	private static final String RESET_PWD_TOKEN_KEY = "muwu:restPwd";
	private static final String ACTIVE_USER = "muwu:activeUser";
	private static final String SEND_SMS_COUNT = "muwu:sms:count";
	private static final String SEND_EMAIL_CODE = "muwu:email:code";
	private static final String ACCESS_TOKEN = "muwu:token:accessToken";
	private static final String UPLOAD_FILE_SIZE = "muwu:file:upload_file_size";
	...
	public static String getAccessTokenKey(String token) {
		...
		return ACCESS_TOKEN + ":" + SecureUtil.md5(token);
	}
