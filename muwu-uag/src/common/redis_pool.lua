...
function _M.connect_mod(self, redis)
    ...
    if self.password and self.password ~= "" then ----密码认证
...
function _M.new(self, opts)
    ...
    local pool_max_idle_time = (opts.pool_max_idle_time and opts.pool_max_idle_time * 1000) or 60000
