 ...
 *
 */
public class MuWuSpringSocialConfigurer extends SpringSocialConfigurer {
	...
	/**
	 * Instantiates a new spring social configurer.
	 *
	 * @param filterProcessesUrl the filter processes url
	 */
	public MuWuSpringSocialConfigurer(String filterProcessesUrl) {
